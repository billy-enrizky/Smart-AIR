...
public class ChildInhalerMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emergencyButton.setOnClickListener(v -> {
                Intent intent = new Intent(ChildInhalerMenu.this, TriageActivity.class);
        ...
        pefButton.setOnClickListener(v -> {
            Intent intent = new Intent(ChildInhalerMenu.this, PEFEntryActivity.class);
            intent.putExtra("childId", childAccount.getID());
            intent.putExtra("parentId", childAccount.getParent_id());
            startActivity(intent);
        });
        techniqueButton.setOnClickListener(v -> {
            startActivity(new Intent(ChildInhalerMenu.this, ChildInhalerInstructions.class));
        });

        dailycheck.setOnClickListener(v -> {
            startActivity(new Intent(ChildInhalerMenu.this, CheckInView.class));
        });
        ...
        logsButton.setOnClickListener(v -> {
            startActivity(new Intent(ChildInhalerMenu.this, ChildInhalerLogs.class));
        });

        useButton.setOnClickListener(v -> {
            startActivity(new Intent(ChildInhalerMenu.this, ChildInhalerUse.class));
        });
